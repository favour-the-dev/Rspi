function Hero() {
    return ( 
        <>
            <div className="flex flex-col items-center px-2 mt-2 ssm:mt-12 lg:mt-4 4k:mt-24 space-y-4 md:h-fit">
                <div className="font-bold text-2xl ssm:text-3xl lg:text-4xl xl:text-5xl 4k:text-8xl uppercase md:w-[70%] text-center text-[#E57C23] font-capri tracking-wider">
                    Welcome to respi Your Go to place to get food recipe's
                </div>
                <div className="md:w-[50%] text-center text-xs lg:text-sm 4k:text-5xl font-semibold tracking-wider">
