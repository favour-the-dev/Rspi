...
function Sidebar() {
    ...
    return ( 
        <>
            <aside className={`md:w-[30%] lg:w-[20%] rounded-r-2xl bg-[#E57C23] text-white h-[100vh] flex`}>
              <div className="flex flex-col relative">
                  ...
                  <div className="flex flex-col mt-8 space-y-2">
                    <NavLink className={({isActive, isPending})=> isPending ? 'p-2 hover:bg-white hover:text-[#E57C23] duration-150 ease-linear rounded-r-md flex gap-3 uppercase' : isActive ? 'text-[#E57C23] bg-white p-2 flex gap-3 uppercase rounded-r-md' : 'p-2 hover:bg-white hover:text-[#E57C23] duration-150 ease-linear rounded-r-md flex gap-3 uppercase'} to='/dash'>
                      <AiFillHome className="text-xl"/> 
                      <p>Home</p>
                    </NavLink>
                    <NavLink className={({isActive, isPending})=> isPending ? 'p-2 hover:bg-white hover:text-[#E57C23] duration-150 ease-linear rounded-r-md flex gap-3 uppercase' : isActive ? 'text-[#E57C23] bg-white p-2 flex gap-3 uppercase rounded-r-md' : 'p-2 hover:bg-white hover:text-[#E57C23] duration-150 ease-linear rounded-r-md flex gap-3 uppercase'} to="/dash/search">
                      <AiOutlineSearch className="text-xl"/> 
                      <p>Search Recipe</p>
                    </NavLink>
                    <NavLink to='/dash/meal' className={({isActive, isPending})=> isPending ? 'p-2 hover:bg-white hover:text-[#E57C23] duration-150 ease-linear rounded-r-md flex gap-3 uppercase' : isActive ? 'text-[#E57C23] bg-white p-2 flex gap-3 uppercase rounded-r-md' : 'p-2 hover:bg-white hover:text-[#E57C23] duration-150 ease-linear rounded-r-md flex gap-3 uppercase'}>
                      <AiOutlineSchedule className="text-xl"/> 
                      <p>Meal Planner</p>
                    </NavLink>
                    <NavLink to='/dash/save' className={({isActive, isPending})=> isPending ? 'p-2 hover:bg-white hover:text-[#E57C23] duration-150 ease-linear rounded-r-md flex gap-3 uppercase' : isActive ? 'text-[#E57C23] bg-white p-2 flex gap-3 uppercase rounded-r-md' : 'p-2 hover:bg-white hover:text-[#E57C23] duration-150 ease-linear rounded-r-md flex gap-3 uppercase'}>
